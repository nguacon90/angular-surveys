angular.module('mwFormBuilder', ['ui.select', 'ngSanitize','ng-sortable', 'pascalprecht.translate']);
...
angular.module('mwFormBuilder').directive('mwQuestionOfferedAnswerListBuilder', function () {
    ...
    return {
        ...
        controller: ["FormQuestionBuilderId", "mwFormUuid", function(FormQuestionBuilderId, mwFormUuid){
            ...
            ctrl.addInputToAnswer=function(answer) {
              answer.showInput = true;
            };
            ctrl.removeInputToAnswer=function(answer) {
...
angular.module('mwFormBuilder').factory("FormSubQuestionBuilderId", function(){
    var id = 0;
        return {
            next: function(){
                return ++id;
    ...
    .directive('mwFormSubQuestionBuilder', function () {
    ...
    return {
        ...
        templateUrl: 'mv-form-sub-question-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$timeout", "mwFormUuid", "FormQuestionBuilderId", "mwFormBuilderOptions", function($timeout,mwFormUuid,FormQuestionBuilderId, mwFormBuilderOptions){
            var ctrl = this;
            // Put initialization logic inside `$onInit()`
            // to make sure bindings have been initialized.
            ctrl.$onInit = function() {
