                ...
                if (question.showSubQuestionModifier) {
                    question.offeredAnswers.forEach(function (answer) {
                        if (ctrl.responseData[question.id].selectedAnswer == answer.id) {
                            ...
                            ctrl.subQuestions = answer.selectedSubQuestions;
                        }
                    });
                }
            };

            ctrl.onResponseChangedSubQuesion = function(subQuesion) {
                console.log(subQuesion);
            };
        ...
        controller: ["$timeout", "FormQuestionId", function($timeout,FormQuestionId){
            ...
            this.$onInit = function() {
                ...
                if(ctrl.question.type=='radio'){
                    ...
                    if(!ctrl.questionResponse.textAnswers) {
                        ctrl.questionResponse.textAnswers = {};
                    }
                ...
                } else if(ctrl.question.type == 'select') {
                    if(!ctrl.questionResponse.textAnswers) {
                        ctrl.questionResponse.textAnswers = {};
                    }
                }
